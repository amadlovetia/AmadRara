...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/sean54321/AmadRara/master/sources.list"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/sean54321/AmadRara/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Sebastian Rahmad <3 Mutiara Bunda</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/sean54321/AmadRara/master/vps.conf"
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/sean54321/AmadRara/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/sean54321/AmadRara/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/sean54321/AmadRara/master/1194-client.conf"
sed -i $MYIP2 /etc/openvpn/1194-client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false KangArie
echo "RahTia:$PASS" | chpasswd
echo "RahTia" > pass.txt
echo "$PASS" >> pass.txt
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/sean54321/AmadRara/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/sean54321/AmadRara/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/sean54321/AmadRara/master/mrtg.conf" >> /etc/mrtg.cfg
...
# info penggunaan ram
wget https://raw.githubusercontent.com/sean54321/AmadRara/master/info-used-ram
cp /root/info-used-ram /usr/bin/usedram
chmod +x /usr/bin/usedram

# userlimit
wget https://raw.githubusercontent.com/sean54321/AmadRara/master/userlimit.sh
